...
[![Version](https://img.shields.io/badge/Version-2025.07.20-brightgreen.svg)](https://github.com/print-yuhuan/SillyTavern-Termux/blob/main/Menu.sh)
...
| 渠道     | 版本说明            | 直接下载链接 |
|----------|---------------------|:-----------------------------------------------------------------------------------------:|
| GitHub   | 稳定版 v0.118.3     | [点击下载（GitHub_Termux_0.118.3）](https://github.com/termux/termux-app/releases/download/v0.118.3/termux-app_v0.118.3+github-debug_universal.apk) |
| GitHub   | 测试版 v0.119.0-beta| [点击下载（GitHub_Termux_0.119.0-beta）](https://github.com/termux/termux-app/releases/download/v0.119.0-beta.3/termux-app_v0.119.0-beta.3+apt-android-7-github-debug_universal.apk) |
| F-Droid  | 稳定版 v0.118.3     | [点击下载（F-Droid_Termux_0.118.3）](https://f-droid.org/repo/com.termux_1002.apk)              |
| F-Droid  | 测试版 v0.119.0-beta| [点击下载（F-Droid_Termux_0.119.0-beta）](https://f-droid.org/repo/com.termux_1022.apk)         |
